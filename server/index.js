...
app.use(
  cors({
    origin: ['http://localhost:5173', 'https://multi-page-tmp-e-commerce.vercel.app'],
...
app.post('/create-order', async (req, res) => {
  ...
  try {
    ...
    const successUrl = `${process.env.SERVER_URL || 'https://multi-page-tmp-e-commerce.vercel.app'}/checkout?ordersuccess=true&orderNumber=${orderNumber}`;
